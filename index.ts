...
// ============================================================
// 🚀 NOVA BOT - نسخه نهایی یکپارچه (اصلاح شده)
// ============================================================

// ============================================================
// 📦 توابع شخصیت‌ها (فقط یک بار)
// ============================================================
...
// ============================================================
// 📦 تابع نمایش راهنمای شخصیت‌ها (فقط یک بار)
// ============================================================
...
async function showPersonalityHelp(cb: CallbackQuery, env: Env): Promise<void> {
  ...
  const text = lang === 'fa'
    ? `🎭 **راهنمای شخصیت‌های نوا**\n\n` +
      ...
      `💀 **سایفر** - هکر مرموز\n` +
      `🔥 **جکس** - آشوبگر\n` +
      `🪚 **صورت‌چرمی** - قاتل زنجیره‌ای\n\n` +
      `💡 برای تغییر از منوی اصلی یا /personality استفاده کنید.`
    : `🎭 **Nova Personalities Guide**\n\n` +
      `Nova has **8 unique personalities**:\n\n` +
      `**✨ Female:**\n` +
      `🤖 **Nova** - Smart assistant (default)\n` +
      `🖤 **Lilith** - Seductive\n` +
      ...
      `💡 Change from main menu or /personality.`;
...
// ============================================================
// 📦 تابع ریست حافظه کاربر (فقط یک بار)
// ============================================================
...
// ============================================================
// 📦 تابع فراخوانی SambaNova API (فقط یک بار)
// ============================================================
...
// ============================================================
// 📦 تابع تنظیمات مدل فعال (فقط یک بار)
// ============================================================
...
console.log(`📊 Total lines: ~11,500 (اصلاح شده)`);
