...
if (selectedModel.type === 'image' || selectedModel.id.includes('flux') || selectedModel.id.includes('turbo')) {
  ...
  // ✅ اگه مدل نامعتبر بود، از flux استفاده کن
...
function getFallbackPollinationsModels(): ModelInfo[] {
  return [
    ...
    // ❌ اینا رو حذف کن (دیگه تو Pollinations نیستن):
    ...
    // ✅ اینا رو جایگزین کن:
    { id: "gpt-4o-mini", name: "GPT-4o Mini", type: "text", description: "Fast & efficient" },
    { id: "gpt-4o", name: "GPT-4o", type: "text", description: "Advanced reasoning" },
    { id: "claude-3-5-sonnet", name: "Claude 3.5 Sonnet", type: "text", description: "Flagship model" },
    { id: "llama-3.3-70b", name: "Llama 3.3 70B", type: "text", description: "Open source model" },
    { id: "qwen-2.5-72b", name: "Qwen 2.5 72B", type: "text", description: "Chinese model" },
    { id: "phi-3", name: "Phi-3", type: "text", description: "Small & efficient" },
    { id: "grok-2", name: "Grok 2", type: "text", description: "XAI model" },
    // ✅ اینا رو نگه دار:
